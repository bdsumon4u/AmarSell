...
class ViewComposerServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        View::composer(['welcome', 'contact-form', 'layouts.*', 'admin.aside.*', 'components.layouts.header', 'components.layouts.footer', 'reseller.layout', 'reseller.products.layout', 'reseller.checkout.content', 'reseller.products.product', 'order.show'], SettingComposer::class);
    }
}
