...
function stopButtonLoading(button) {
  ...
  button.data('loading-text', button.html()).removeClass('btn-loading').button('reset');
}
...
$(function () {
  ...
  var productSlider2 = $('.product-slider-2');
  productSlider.slick({
    autoplay: false,
    autoplaySpeed: 10000,
    dots: false,
  ...
  var landscapeProducts = $('.landscape-products');
  ...
  function productImage() {
    ...
    $('.base-image-inner img').each(function (i, img) {
      new drift_zoom__WEBPACK_IMPORTED_MODULE_0__["default"](img, {
        sourceAttribute: 'src',
  ...
  $('#coupon-apply-form').on('submit', function (e) {
    if ($('#coupon').val() === '') {
      e.preventDefault();
      stopButtonLoading($('#coupon-apply-submit'));
    }
  });
  $('.cart-list .btn-update').on('click', function (e) {
    $(e.currentTarget).addClass('fa-spin');
    var quantity = $(e.currentTarget.dataset.quantityField).val();
    var form = $("\n            <form method=\"POST\" action=\"".concat(route('cart.items.update', e.currentTarget.dataset.id), "\">\n                <input type=\"hidden\" name=\"_token\" value=\"").concat(FleetCart.csrfToken, "\">\n                <input type=\"hidden\" name=\"_method\" value=\"put\">\n                <input type=\"hidden\" name=\"qty\" value=\"").concat(quantity, "\">\n            </form>\n        "));
  ...
  $('.shipping-method').on('change', function (e) {
    $.ajax({
      ...
      data: {
        shipping_method: e.currentTarget.value
      },
      success: function success(response) {
        $('#coupon-value').html("&#8211;".concat(response.discount));
        $('#total-amount').text(response.total);
      }
    });
  });
  var hasShippingMethod = !!$('meta[name="cart-has-shipping-method"]').attr('content');
  ...
  $('#billing-country, #shipping-country').on('change', function (e) {
    var stateFieldSelector;
    var inputField;
    var selectField;
    ...
    $.ajax({
      ...
      success: function success(states) {
        var oldState = $(stateFieldSelector).val();
        ...
        var options = "<option value=\"\" selected>".concat(trans('storefront::checkout.please_select'), "</option>");
  ...
  function getTaxesHtml(taxes) {
    ...
    var _iterator3 = _createForOfIteratorHelper(taxes),
        _step3;

    try {
      for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
        var tax = _step3.value;
        html += "\n                <span class=\"item-amount\">\n                    ".concat(tax.name, "\n                    <span>").concat(tax.amount, "</span>\n                </span>\n            ");
      }
    } catch (err) {
      _iterator3.e(err);
    } finally {
...
module.exports = __webpack_require__(/*! K:\AmarSell\resources\js\fleetcart.js */"./resources/js/fleetcart.js");
